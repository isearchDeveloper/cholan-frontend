...
export const metadata: Metadata = {
  title: "Our-Partners - Hotels,Train & Houseboats",
  description: "Cholan Tours - Our Partners",
};
interface CMSMeta {
  meta_title?: string;
...
async function getPageDetails(): Promise<CMSDetails | null> {
  try {
    const res = await fetch(
      `${process.env.NEXT_PUBLIC_UAT_URL}/api/v1/cms/page/details?slug=our-partners`,
      {
        method: "GET",
        headers: {
  ...
  return (
    <div className="min-vh-100 bg-light">
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0,0,0,0.0), rgba(0,0,0,0.2)), url('${
            pageData.banner_image || "/images/banner.jpg"
          }')`,
      ...
      >
        ...
        <img
          ...
          alt={pageData.banner_image_alt || "partner Banner"}
          className="d-none"
        />
      </section>
      ...
      <section className="pt-4">
        <div className="container ">
          ...
          <div className="card border-0">
            <div className="p-4">
              <h1 className="fs-2 mb-3 ">{pageData.title || "partner"}</h1>
