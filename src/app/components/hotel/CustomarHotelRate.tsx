...
const CustomarHotelRate: React.FC<Props> = ({ reviews }) => {
        ...
        <section className="customer-rate common-padd pt-0">
            <div className="container">
                <div className="common-header-center">
                    <h2 className="color-blue fs-3">
                        Customers who stayed in Luxury Hotels with Cholan Tours
                    </h2>
                </div>
                ...
                <div className="customer-rate-wraper">
                    ...
                    <div className="btm-button">
                        <button onClick={() => router.push("/reviews/hotels")} className="btn blue-btn">
                            See All Reviews
                            <span>
                                <Image
                                    width={23}
...
export default CustomarHotelRate;