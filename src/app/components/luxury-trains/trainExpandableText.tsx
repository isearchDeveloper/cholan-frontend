...
interface ExpandableTextProps {
  ...
  subtitle?: string;
  text: string;
  collapsedLines?: number; // not used anymore but can be removed
}

const ExpandableText: React.FC<any> = ({
  title,
  subtitle,
  text,
}) => {
  ...
  return (
    <div>
      <h1 className="mb-2 fs-2 color-blue">Overview</h1>
      ...
      <div className="mb-0 text-sm">
        <div
          dangerouslySetInnerHTML={{
            __html: expanded || !isLongText ? text : displayText + "...",
          }}
        />
      </div>
