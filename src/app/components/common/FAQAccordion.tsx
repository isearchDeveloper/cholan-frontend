...
const FAQAccordion: React.FC<FAQAccordionProps> = ({ faqs, location }) => {
    ...
    return (
        <>
            {/* -------- Schema Inject (Only if FAQs Exist) -------- */}
            {faqSchema && (
                <script
            ...
            <div className="row justify-content-center">
                <div className="col-lg-12">
                    <div className="faq-container">
                        <h2 className="mb-4 fs-3 text-center text-lg-start color-blue">
                            {location ? location : ""}
                        </h2>
