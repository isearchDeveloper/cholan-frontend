...
const InclusionExclusionComponent: any = ({ inclusion, exclusion }: any) => {
  ...
  return (
    <div
      className={`inc-exc gap-4 gap-lg-0 ${
        inclusion.length < 1 || inclusion[0] == "" ? null : "row my-4"
      }`}
    >
          ...
          <div className="p-4 bg-success-bg rounded h-100">
            ...
            <ul className="list-unstyled d-flex flex-column gap-2">
              {inclusion?.map((item: any , index: any) => (
                <li key = {index} className="text-success d-flex align-items-flex-start text-sm">
                  <span className="me-3">
                    <svg
                      width="20"
                      height="20"
          ...
          <div className="p-4 bg-danger-bg rounded h-100">
            ...
            <ul className="list-unstyled d-flex flex-column gap-2">
              {exclusion.map((item: any, index: any) => (
                <li  key ={index} className="text-danger d-flex align-items-flex-start text-sm">
                  <span className="me-3">
                    <svg
                      width="20"
                      height="20"
