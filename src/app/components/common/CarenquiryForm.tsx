...
const CarEnquiryForm: React.FC<any> = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!validateForm()) {
      // toast.error('Please fix the errors in the form', { toastId: 'form-validation-errors' });
    ...
    try {
      ...
      if (response.data.success) {
        ...
        // toast.error(response.data.message || 'Submission failed. Try again.', { toastId: 'form-submission-failed' });
      }
    } catch (err: any) {
      // toast.error(err.response?.data?.message || 'Error submitting enquiry', { toastId: 'form-api-error' });
    } finally {
  ...
  return (
    <>
      ...
      <div className="tourCard mb-lg-0 shadow-sm p-lg-4 mt-lg-0">
        <h2 className="mb-1 fw-bold fs-3">Rent a Car Easily</h2>
        {/* <p>
