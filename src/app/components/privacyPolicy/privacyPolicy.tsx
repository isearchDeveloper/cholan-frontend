...
export const metadata: Metadata = {
  title: "Privacy Policy Cholan Tours",
  description:
...
async function getPageDetails(): Promise<CMSDetails | null> {
  try {
    const res = await fetch(
      `${process.env.NEXT_PUBLIC_UAT_URL}/api/v1/cms/page/details?slug=privacy-policy`,
      {
        method: "GET",
        headers: {
    ...
    console.error("Failed to fetch Privacy Policy details:", error);
    return null;
  }
}
    ...
    <div className="min-vh-100 bg-light">
      ...
      >
        ...
        <img
          ...
          alt={pageData.banner_image_alt || "Privacy Policy Banner"}
          className="d-none"
        />
