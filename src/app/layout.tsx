  ...
  return (
    <html lang="en">
      ...
      <body className={`no-js ${inter.variable}`}>
        ...
        {/* ✅ GTM / Head HTML from API */}
        {meta.meta_details && (
          <div dangerouslySetInnerHTML={{ __html: meta.meta_details }} />
        )}

        {/* ✅ GTM / Body HTML from API */}
        {meta.meta_body_details && (
          <div dangerouslySetInnerHTML={{ __html: meta.meta_body_details }} />
        )}
